...
class Sae(nn.Module):
    ...
    def load_many_from_hub(
        ...
        *,
        ...
        # Added local_dir
        repo_path = Path(snapshot_download(name, allow_patterns=pattern, local_dir="/n/netscratch/hlakkaraju_lab/Lab/aaronli/sae"))
    ...
    def load_from_hub(
        ...
        *,
        ...
        repo_path = Path(
            snapshot_download(
                name, allow_patterns=f"layer_{layer}/*" if layer is not None else None, local_dir="/n/netscratch/hlakkaraju_lab/Lab/aaronli/sae"
            )
        )
